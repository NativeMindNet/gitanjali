...
Implementation will replace the starter Flutter template in `app/gitanjali` with a staged offline reader application driven by the legacy `Gitanjali` XML and bundled media. Work is split so that each phase leaves the app in a runnable and testable state: first establish app structure and assets, then load/parse the book, then render/navigate pages, then add bookmarks/search/audio, and finally harden with tests and polish.
...
- **Files**:
  - `app/gitanjali/pubspec.yaml` - Modify
  - `app/gitanjali/lib/main.dart` - Modify
  - `app/gitanjali/lib/src/app/` - Create
  - `app/gitanjali/lib/src/domain/` - Create
  - `app/gitanjali/lib/src/data/` - Create
  - `app/gitanjali/lib/src/presentation/` - Create
- **Dependencies**: None
...
- **Description**: Copy or reorganize required XML, image, audio, and font assets from `legacy/legacy_gitanjajali_swift/Gitanjali/Resources` into `app/gitanjali/assets` and declare them in `pubspec.yaml`.
- **Files**:
  - `app/gitanjali/assets/book/` - Create
  - `app/gitanjali/assets/images/` - Create
  - `app/gitanjali/assets/audio/` - Create
  - `app/gitanjali/assets/fonts/` - Create
  - `app/gitanjali/pubspec.yaml` - Modify
...
- **Files**:
  - `app/gitanjali/lib/src/domain/models/` - Create
  - `app/gitanjali/lib/src/domain/services/` - Create
  - `app/gitanjali/lib/src/domain/repositories/` - Create
- **Dependencies**: Task 1.1
...
- **Files**:
  - `app/gitanjali/lib/src/data/assets/` - Create
  - `app/gitanjali/lib/src/data/parsing/` - Create
  - `app/gitanjali/lib/src/data/repositories/book_repository_impl.dart` - Create
  - `app/gitanjali/test/` - Modify/Create parser-focused tests
...
- **Files**:
  - `app/gitanjali/lib/src/data/persistence/` - Create
  - `app/gitanjali/lib/src/data/repositories/reader_state_store_impl.dart` - Create
  - `app/gitanjali/lib/src/data/repositories/bookmark_store_impl.dart` - Create
  - `app/gitanjali/test/` - Modify/Create persistence tests
...
- **Files**:
  - `app/gitanjali/lib/src/app/bootstrap/` - Create
  - `app/gitanjali/lib/src/presentation/reader/reader_controller.dart` - Create
  - `app/gitanjali/lib/main.dart` - Modify
  - `app/gitanjali/test/` - Modify/Create bootstrap/controller tests
...
- **Files**:
  - `app/gitanjali/lib/src/presentation/reader/screens/reader_screen.dart` - Create
  - `app/gitanjali/lib/src/presentation/reader/widgets/` - Create
  - `app/gitanjali/test/` - Modify/Create reader widget tests
...
- **Files**:
  - `app/gitanjali/lib/src/presentation/reader/reader_controller.dart` - Modify
  - `app/gitanjali/lib/src/presentation/reader/widgets/` - Modify
  - `app/gitanjali/test/` - Modify/Create navigation tests
...
- **Files**:
  - `app/gitanjali/lib/src/presentation/bookmarks/` - Create
  - `app/gitanjali/lib/src/presentation/reader/reader_controller.dart` - Modify
  - `app/gitanjali/lib/src/data/repositories/bookmark_store_impl.dart` - Modify
  - `app/gitanjali/test/` - Modify/Create bookmark tests
...
- **Files**:
  - `app/gitanjali/lib/src/presentation/search/` - Create
  - `app/gitanjali/lib/src/presentation/reader/reader_controller.dart` - Modify
  - `app/gitanjali/lib/src/domain/services/` - Modify/Create search abstractions
  - `app/gitanjali/test/` - Modify/Create search tests
...
- **Files**:
  - `app/gitanjali/lib/src/data/audio/` - Create
  - `app/gitanjali/lib/src/presentation/audio/` - Create
  - `app/gitanjali/lib/src/presentation/reader/reader_controller.dart` - Modify
  - `app/gitanjali/test/` - Modify/Create audio service tests
- **Dependencies**: Tasks 2.1, 2.4
...
- **Files**:
  - `app/gitanjali/README.md` - Modify
  - `app/gitanjali/lib/main.dart` - Modify
  - `app/gitanjali/test/widget_test.dart` - Modify or Delete
  - `app/gitanjali/lib/src/...` - Modify
...
- **Files**:
  - `app/gitanjali/test/` - Modify/Create
  - `app/gitanjali/lib/src/...` - Modify if fixes are needed
...
- **Files**:
  - `app/gitanjali/lib/src/presentation/reader/widgets/` - Modify/Create
...
| File | Action | Reason |
|------|--------|--------|
| `app/gitanjali/pubspec.yaml` | Modify | Add assets, fonts, and implementation dependencies |
| `app/gitanjali/lib/main.dart` | Modify | Replace starter entrypoint with app bootstrap |
| `app/gitanjali/lib/src/app/...` | Create | App composition and bootstrap |
| `app/gitanjali/lib/src/domain/...` | Create | Book, page, control, bookmark, and reader models |
| `app/gitanjali/lib/src/data/...` | Create | Asset loading, XML parsing, persistence, audio integrations |
| `app/gitanjali/lib/src/presentation/...` | Create | Reader, search, bookmarks, and audio UI |
| `app/gitanjali/assets/...` | Create | Migrated XML, images, audio, and font assets |
| `app/gitanjali/test/...` | Modify/Create | Replace template tests with feature-focused coverage |
...
1. Keep all migration work isolated inside `app/gitanjali` and SDD artifacts; do not modify the legacy source.
