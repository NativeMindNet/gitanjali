...
- (id)initWithFrame:(CGRect)frame
{
	if((self = [super initWithFrame: frame]))
	{
		...
		_playIcon = [[UIImage imageNamed: @"play.gif"] retain];
		_playIconHighlighted = [[UIImage imageNamed: @"next.gif"] retain];
		
		_pauseIcon = [[UIImage imageNamed: @"previous.gif"] retain];
		_pauseIconHighlighted = [[UIImage imageNamed: @"down-arrow.png"] retain];
...
//		[self addSubview: _shrinkExpandButton];
		...
		_noSoundLabel.textColor = [UIColor whiteColor];
